...
export const PRODUCT_QUERY = 'SELECT product_id as id, product_name as name, description FROM info ';
export const USER_HISTORY_PURCHASE_QUERY = 'SELECT user_id as id, product_id as product_id FROM user_purchase_history ';
export const USER_QUERY = 'SELECT user_id as id FROM users ';
